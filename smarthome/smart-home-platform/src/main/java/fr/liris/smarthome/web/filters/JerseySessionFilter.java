package fr.liris.smarthome.web.filters;
...
import fr.liris.smarthome.bean.WebSession;
import fr.liris.smarthome.bean.WebSessionManager;
...
//				chain.doFilter(request, response);
			...
			logger.debug("ERROR");
			((HttpServletResponse)response).sendError(500, "Session expired");
		}
	}
